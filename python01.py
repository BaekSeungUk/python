...
list_a.pop()
print("pop 사용후 list_a : {0}".format(list_a))
list_a.pop(1)
print("pop을 사용하여 지정한 위치 index의 데이터 삭제 : {0}".format(list_a))
...
list_a.append(8)
list_a.append(9)
print("append 사용후 list_a : {0}".format(list_a))

list_a.insert(1, 2)
list_a.insert(2, 3)
print("insert 사용후 list_a : {0}".format(list_a))
...
list_b.sort()
print("sort 사용후 list_b : {0}".format(list_b))
